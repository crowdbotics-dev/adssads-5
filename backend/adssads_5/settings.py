"""
Django settings for adssads_5 project.
...
WSGI_APPLICATION = 'adssads_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "adssads_5 API",
    "DESCRIPTION": "API documentation for adssads_5 App",
    "VERSION": "v1",
}
